...
-   Create 2 graphs
    ...
    -   one that show how yield anomaly in general vareies with your parameters (maybe could be the change in profit?? Ojas didn't really know)
    -   Gonna need to change the function to output yield per year???
